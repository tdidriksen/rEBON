...
feature -- Status report
	...
	valid_classifier (a_classifier: STRING): BOOLEAN
		local
			temp: STRING
		do
			create temp.make_from_string (a_classifier)
...
feature -- Element change
	...
	set_entries (some_entries: EVENT_ENTRIES)
		do
	...
	add_entries (some_entries: EVENT_ENTRIES)
		do
	...
	add_entry (an_entry: EVENT_ENTRY)
		do
...
feature -- Removal
	...
	remove_entries (some_entries: EVENT_ENTRIES)
		do
	...
	remove_entry (an_entry: EVENT_ENTRY)
		do
