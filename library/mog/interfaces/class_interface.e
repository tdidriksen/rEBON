...
feature -- Element change
	...
	set_parents (some_parents: CLASS_TYPE_LIST)
		do
			my_parents := some_parents.twin
		ensure
	...
	add_parents (some_parents: CLASS_TYPE_LIST)
		do
...
--			some_parents.is_subset (parents)
	...
	add_parent (a_parent: CLASS_TYPE)
		require
			a_parent /= Void
		do
...
--			class_invariant.is_empty
	...
	remove_indices (some_indices: INDEX_LIST)
		do
...
-- 			index.is_disjoint (some_indices)
	...
	remove_index (an_index: INDEX_CLAUSE)
		do
...
-- 			index.is_disjoint (an_index)
	...
	remove_parents (some_parents: CLASS_TYPE_LIST)
		do
...
-- 			parents.is_disjoint (some_parents)
	...
	remove_parent (a_parent: CLASS_TYPE)
		do
	...
	remove_features (some_features: FEATURE_CLAUSE_LIST)
		do
-- 			my_parents.subtract (some_parents)
-- 		ensure
-- 			parents.is_disjoint (some_parents)
	...
	remove_feature (a_feature: FEATURE_CLAUSE)
		do
	...
	remove_class_invariants (some_invariants: INVARIANT_LIST)
		do
-- 			my_parents.subtract (some_parents)
-- 		ensure
-- 			parents.is_disjoint (some_parents)
